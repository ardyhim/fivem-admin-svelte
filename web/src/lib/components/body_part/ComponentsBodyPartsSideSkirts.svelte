<script lang="ts">
  ...
  let data = [
    { paint: { label: "Side Skirts 1" }, value: true },
    { paint: { label: "Side Skirts 2" }, value: false },
    { paint: { label: "Side Skirts 3" }, value: false },
    { paint: { label: "Side Skirts 4" }, value: false },
    { paint: { label: "Side Skirts 5" }, value: false },
    { paint: { label: "Side Skirts 6" }, value: false },
    { paint: { label: "Side Skirts 7" }, value: false },
    { paint: { label: "Side Skirts 8" }, value: false },
    { paint: { label: "Side Skirts 9" }, value: false },
  ];
...
<div in:fade={{ easing: quadIn, duration: 250 }} class="flex flex-col">
  <h1 class="font-semibold">Body Parts Side Skirts</h1>
  {#each data as d, i}
    <div
