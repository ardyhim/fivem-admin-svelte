<script lang="ts">
  ...
  let data = [
    { paint: { label: "Front Bumper 1" }, value: true },
    { paint: { label: "Front Bumper 2" }, value: false },
    { paint: { label: "Front Bumper 3" }, value: false },
    { paint: { label: "Front Bumper 4" }, value: false },
    { paint: { label: "Front Bumper 5" }, value: false },
    { paint: { label: "Front Bumper 6" }, value: false },
    { paint: { label: "Front Bumper 7" }, value: false },
    { paint: { label: "Front Bumper 8" }, value: false },
    { paint: { label: "Front Bumper 9" }, value: false },
  ];
...
<div in:fade={{ easing: quadIn, duration: 250 }} class="flex flex-col">
  <h1 class="font-semibold">Body Parts Front Bumper</h1>
  {#each data as d, i}
    <div
