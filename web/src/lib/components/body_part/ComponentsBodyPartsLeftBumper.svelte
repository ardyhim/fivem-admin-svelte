<script lang="ts">
  ...
  let data = [
    { paint: { label: "Left Bumper 1" }, value: true },
    { paint: { label: "Left Bumper 2" }, value: false },
    { paint: { label: "Left Bumper 3" }, value: false },
    { paint: { label: "Left Bumper 4" }, value: false },
    { paint: { label: "Left Bumper 5" }, value: false },
    { paint: { label: "Left Bumper 6" }, value: false },
    { paint: { label: "Left Bumper 7" }, value: false },
    { paint: { label: "Left Bumper 8" }, value: false },
    { paint: { label: "Left Bumper 9" }, value: false },
  ];
...
<div in:fade={{ easing: quadIn, duration: 250 }} class="flex flex-col">
  <h1 class="font-semibold">Body Parts Left Bumper</h1>
  {#each data as d, i}
    <div
